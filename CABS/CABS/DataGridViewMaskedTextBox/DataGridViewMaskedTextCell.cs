...
namespace JThomas.Controls
{
    ...
    public class DataGridViewMaskedTextCell : DataGridViewTextBoxCell
    {
        ...
        protected override bool SetValue(int rowIndex, object value)
        {
            ...
            {
                MaskedTextBox editingControl = new MaskedTextBox(Mask);
                editingControl.Text = value.ToString();
                val = editingControl.Text;
            }
        ...
        public object ValueWithoutMask
        {
            get
            {
                if (Mask != null && Mask != "" && Value != null)
                {
                    MaskedTextBox editingControl = new MaskedTextBox(Mask);
                    editingControl.Text = Value.ToString();
                    editingControl.TextMaskFormat = MaskFormat.ExcludePromptAndLiterals;
